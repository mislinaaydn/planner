            ...
            <div class="col-12 col-md-6 ">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item cursor-pointer" @click="$router.push('/NoteView')"><a></a>Notlar
                        </li>
                        <li class="breadcrumb-item active">Not güncelle</li>
                    </ol>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 card plan">
                <h2 class="text-center">Not Güncelleme</h2>
