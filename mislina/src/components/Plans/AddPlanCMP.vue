<template>
            ...
            <div class="col-12 col-md-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item cursor-pointer" @click="$router.push('/PlanView')">Planlar</li>
                        <li class="breadcrumb-item active">Plan ekleme</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="plan card">
                    <h2 class="text-center">Plan Ekleme</h2>
